...
public class CinemaController {
    ...
    public ResponseEntity<?> stats(@RequestParam(value="password", required = false) String password) {
        if(password != null && password.equals("super_secret")){
            ...
            stat.put("current_income", income);
            stat.put("number_of_available_seats", cinema.getAvailable_seats().size());
            stat.put("number_of_purchased_tickets", cinema.getOrderedSeats().size());
